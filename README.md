This file contains the codes used for the IDA early warning tool project. It contains scripts usable for patient data collected from GGZ Drenthe. These scripts do as follows:
